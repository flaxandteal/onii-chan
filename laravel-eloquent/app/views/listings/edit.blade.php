...
{{ Form::model($listing, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('listings.update', $listing->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('listings.show', 'Cancel', $listing->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
